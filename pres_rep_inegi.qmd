...
- En la etapa de procesamiento se hizo una limpieza y normalización de las bases. Se eliminaron los runes inválidos identificados en el paso anterior, los registros duplicados, y los valores atípicos de la variable edad, entre otras modificaciones
...
::: {.incremental .medium-par layout-ncol=2 layout-valign="center"}s
